...
#ifndef __ATK_QMI8658_H
#define __ATK_QMI8658_H
...
/****************************************************************************************************************/
/* 函数声明 */
uint8_t atk_qmi8658_init(void);                                         /* 初始化QMI8658 */
float atk_qmi8658_get_temperature(void);                                /* 获取传感器温度 */
void atk_qmi8658_reset(void);                                           /* 复位传感器 */
void atk_qmi8658_read_xyz(float *acc, float *gyro);                     /* 获取加速度计和陀螺仪的三轴数据 */
